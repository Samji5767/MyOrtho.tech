...
export const CAD_CAPABILITIES: CadCapability[] = [
  ...
  },
  {
    ...
    phase: "review",
    maturity: "planned",
    summary: "On-mesh distance, angle, tooth-width, overjet and overbite measurement tools.",
    statusNote: "ClinicalMeasurement model defined; measurement tooling planned for the viewer.",
    surface: null,
  },
  {
